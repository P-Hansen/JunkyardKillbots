...
items[1].item = instance_create_layer(items[1].x, items[1].y, layer, club2Item);
items[1].item.slot = items[1];
items[1].item.slot.stackCount++;
items[12].item = instance_create_layer(items[12].x, items[12].y, layer, club2Item);
items[12].item.slot = items[12];
items[12].item.slot.stackCount++;
items[13].item = instance_create_layer(items[13].x, items[13].y, layer, club2Item);
