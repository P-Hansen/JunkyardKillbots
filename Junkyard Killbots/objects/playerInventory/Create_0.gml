...
items[12].item = instance_create_layer(items[12].x, items[12].y, layer, speedUpChip1);
items[12].item.slot = items[12];
items[12].item.slot.stackCount++;
items[13].item = instance_create_layer(items[13].x, items[13].y, layer, speedUpChip1);
