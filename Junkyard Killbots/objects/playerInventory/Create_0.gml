...
robots[1].bots = instance_create_layer(robots[1].x, robots[1].y, layer, bigHoverBotPortrit);
...
blueprints[2] = instance_create_layer(-1000, -1000, layer, bigHoverBotBlueprint);
