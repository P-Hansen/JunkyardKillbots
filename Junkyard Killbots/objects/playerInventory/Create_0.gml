...
//starting 3 bots
robots[3].bots = instance_create_layer(robots[3].x, robots[2].y, layer, minibotPortrit);
...
robots[7].bots = instance_create_layer(robots[7].x, robots[8].y, layer, minibotPortrit);
